...
`service_id`: puse `se/semana` para los días de la semana incluyendo sábados, y `se/fin_de_semana` para los domingos y feriados.
...
Puse los próximos feriados en 2026 en La Paz, según https://www.feriados.com.bo/: 6 de agosto, 7 de agosto, 2 de noviembre y 25 de diciembre. Para estos cuatro días, di de baja el servicio `se/semana` y di de alta el servicio `se/fin_de_semana`, porque se aplica el horario de domingo en feriados.
